        ...
        <div className="auth-form-panel">
          ...
          >
            ...
            <form className="auth-form" onSubmit={handleSubmit} noValidate>
              ...
              >
                <button type="button" className="auth-social-btn google" onClick={() => alert('Google signup coming soon!')}>
                ...
                <button type="button" className="auth-social-btn apple" onClick={() => alert('Apple signup coming soon!')}>
                  <svg viewBox="0 0 24 24" fill="currentColor">
